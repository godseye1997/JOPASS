...
insert into public.services (id, vendor_id, name, duration, price, jopass_price, credits) values
  (101, 1, 'Open Gym Session',    '60 min',  5,  3,  6),
  (102, 1, 'Group HIIT Class',    '45 min',  7,  4,  8),
  (103, 1, 'Personal Training',   '60 min',  14, 8,  16),
  (201, 2, 'Haircut & Style',     '45 min',  9,  5,  10),
  (202, 2, 'Color Treatment',     '90 min',  18, 10, 20),
  (203, 2, 'Blowout',             '30 min',  6,  3,  6),
  (301, 3, 'Swedish Massage',     '60 min',  11, 6,  12),
  (302, 3, 'Deep Tissue Massage', '60 min',  14, 8,  16),
  (303, 3, 'Hot Stone Therapy',   '75 min',  17, 10, 20),
  (401, 4, 'Express Facial',      '30 min',  7,  4,  8),
  (402, 4, 'Gel Manicure',        '40 min',  5,  3,  6),
  (403, 4, 'Full Glam Makeup',    '60 min',  12, 7,  14),
  (501, 5, 'Climbing Session',    '90 min',  9,  5,  10),
  (502, 5, 'CrossFit Class',      '60 min',  7,  4,  8),
  (503, 5, 'Yoga Flow',           '60 min',  5,  3,  6),
  (601, 6, 'Aromatherapy Massage','60 min',  12, 7,  14),
  (602, 6, 'Reflexology',         '45 min',  9,  5,  10),
  (603, 6, 'Couples Massage',     '75 min',  24, 14, 28),
  (701, 7, 'Open Gym Access',     '120 min', 4,  2,  4),
  (702, 7, 'Powerlifting Coach',  '60 min',  18, 10, 20),
  (703, 7, 'Boxing Class',        '60 min',  8,  5,  10),
  (801, 8, 'Classic Manicure',    '30 min',  4,  2,  4),
  (802, 8, 'Spa Pedicure',        '45 min',  7,  4,  8),
  (803, 8, 'Nail Art Set',        '60 min',  10, 6,  12)
on conflict (id) do nothing;
